    ...
    <div class="main-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="uiComponents">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="?hal=DataSiswa" class="nav-link">Data Siswa</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="advancedUI">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="?hal=DataPetugas" class="nav-link">Data Petugas</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="forms">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="?hal=DataKelas" class="nav-link">Data Kelas</a>
                                </li>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav sub-menu">
                                <li class="nav-item">
                                    <a href="?hal=DataSpp" class="nav-link">Data SPP</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="?hal=GenerateLaporan" class="nav-link">
        ...
        <div class="page-wrapper">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown nav-profile">
                            <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                                ...
                                <img src="../assets/images/faces/stmj.png" alt="profile">
                            </a>
                            <div class="dropdown-menu" aria-labelledby="profileDropdown">
                                <div class="dropdown-header d-flex flex-column align-items-center">
                                    <div class="figure mb-3">
                                        <img src="../assets/images/faces/stmj.png" alt="">
                                    </div>
            ...
            <footer class="footer d-flex flex-column flex-md-row align-items-center justify-content-between">
                <p class="text-muted text-center text-md-left">Copyright © 2019 <a href="wa.me/0881026002302"
                        target="_blank">Rizki</a>. All rights reserved</p>
