...
<div class="alert alert-primary" role="alert">
    Anda Bisa Melihat Detail Siswa Pada Halaman Data Siswa
</div>
<div class="table-responsive">
    ...
    <thead class="thead-dark">
        ...
        <tbody>
            ...
            $no = 1;
            $sql = $koneksi->query("SELECT * FROM pembayaran WHERE nisn='$nisn' ORDER BY id_pembayaran ASC");
            ...
            echo "<tr>
                                ...
                                if($data['kode_pembayaran']==''){
                                    ...
                                    echo " <a class='btn btn-primary' href='Beranda.php?hal=LaporanCetak&id_pembayaran=$data[id_pembayaran]'>Cetak</a>";
                                }
                                echo "</td>
                                </tr>";
                                $no++;
