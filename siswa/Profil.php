<?php
    ...
    $sql = $koneksi->query("SELECT * FROM siswa WHERE nisn='$username'");
                ...
                <div class="cover">
                    ...
                    <div class="cover-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="profile-name"><?php echo $tampil['nama'] ?></span>
                        </div>
        ...
        <div class="d-none d-md-block col-md-12 col-xl-12">
            <div class="card rounded">
                <div class="card-body">
                    ...
                    <p>Hi! aku <?php echo $tampil['nama_petugas'] ?>. Aku adalah <?php echo $tampil['level'] ?> di Hatimuu
                        .</p>
                    <div class="mt-3">
